...
class TestConversationRepository:
    ...
    def test_create_settings(self, injector):
        """Test creating conversation settings"""
        repo = injector.get(ConversationRepository)
    ...
    def test_get_settings(self, injector):
    ...
    def test_update_settings(self, injector):
    ...
    def test_characters_serialization(self, injector):
