...
class TestCharacterRecordRepository:
    ...
    def test_create_character(self, injector, sample_conversation_id):
        """Test creating a character record"""
        repo = injector.get(CharacterRecordRepository)
    ...
    def test_get_character(self, injector, sample_conversation_id):
    ...
    def test_get_characters_by_conversation(self, injector, sample_conversation_id):
    ...
    def test_update_character(self, injector, sample_conversation_id):
    ...
    def test_delete_characters_by_message_id(self, injector, sample_conversation_id):
